...
export default function SongPreviewPage() {
  ...
  const song = {
    ...
    emotionalHook: "A song that understands your heart. Every note, every word—written for you.",
    coverUrl: "/kanye.jpg",
    previewUrl: "#",
    price: "$1.99",
  }
      ...
      <div className="relative min-h-screen flex items-center justify-center">
        ...
        <main className="relative z-10 w-full max-w-5xl mx-auto px-6 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {/* Artist */}
            <p className="text-xl md:text-2xl text-gray-300 mb-6 font-light tracking-wide">{song.artist}</p>
            ...
            {/* Description */}
            <p className="text-lg text-gray-300 mb-8 leading-relaxed max-w-xl">{song.description}</p>
            ...
            <div className="bg-gradient-to-r from-amber-400/10 to-amber-400/5 border border-amber-400/30 rounded-xl p-6 mb-10 backdrop-blur-sm">
              <p className="text-lg text-amber-100 font-medium italic text-balance">{song.emotionalHook}</p>
            </div>
