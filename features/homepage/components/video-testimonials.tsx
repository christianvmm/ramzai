...
const videoTestimonials = [
  {
    ...
    posterUrl: "/video-testimonial-1.jpg", // Added poster thumbnail
    name: "Juan Pérez",
    title: "Empresario",
    duration: "2:15",
  },
  {
    ...
    posterUrl: "/video-testimonial-2.jpg", // Added poster thumbnail
    name: "María López",
    title: "Artista",
    duration: "1:45",
  },
  {
    ...
    posterUrl: "/video-testimonial-3.jpg", // Added poster thumbnail
  ...
  },
  {
    ...
    posterUrl: "/video-testimonial-4.jpg", // Added poster thumbnail
    name: "Sofía García",
    title: "Emprendedora",
    duration: "2:30",
  },
  {
    ...
    posterUrl: "/video-testimonial-5.jpg", // Added poster thumbnail
    name: "Luis Rodríguez",
    title: "Músico",
    duration: "2:00",
  },
...
export function VideoTestimonials() {
  ...
  const handlePrev = () => {
    setCurrentIndex((prev) => (prev === 0 ? videoTestimonials.length - 3 : prev - 1))
  }

  const handleNext = () => {
    setCurrentIndex((prev) => (prev >= videoTestimonials.length - 3 ? 0 : prev + 1))
  }
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-gray-600 text-lg font-light">Historias reales convertidas en canciones inolvidables.</p>
        </div>
